...
export const MOCK_NOTICES: NoticeRecord[] = [
  ...
  },
  {
    ...
    destination: "NIRA – Central Division District Office",
    cardLocationType: "DISTRICT_OFFICE",
    cardLocationOfficeId: "loc-kla-central",
    cardLocationText: "NIRA Central Division District Office",
    cardBatchNumber: "CTRL-2026-0231",
    receivingOfficeEmail: "central.division@nira.go.ug",
